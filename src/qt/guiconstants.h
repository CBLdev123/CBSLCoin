...
/* Cbslcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cbslcoin"
#define QAPP_ORG_DOMAIN "cbslco.in"
#define QAPP_APP_NAME_DEFAULT "Cbslcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Cbslcoin-Qt-testnet"
