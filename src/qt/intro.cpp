...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cbslcoin Core"),
     ...
     * override -datadir in the cbslcoin.conf file in the default data directory
     * (to be consistent with cbslcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
