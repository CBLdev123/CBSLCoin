...
// Repair parameters
const QString CBSLCOINWALLET("-cbslcoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_cbslcoinwallet, SIGNAL(clicked()), this, SLOT(walletCbslcoin()));
...
/** Restart wallet with "-cbslcoinwallet" */
void RPCConsole::walletCbslcoin()
{
    buildParameterlist(CBSLCOINWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Cbslcoin RPC console.") + "<br>" +
