...
/** Utility functions used by the Cbslcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CBSL addresses in monospace font
...
// Parse "cbslcoin:" URI into recipient object, return true on successful parsing
