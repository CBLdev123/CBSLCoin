...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cbslcoin Core cbslcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cbslcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cbslcoin transaction") + "\n" +
                               "  cbslcoin-tx [options] -create [commands]   " + _("Create hex-encoded cbslcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cbslcoin transaction
