...
#if defined(NDEBUG)
#error "Cbslcoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    else if (nHeight >=  272801 && nHeight <=  338500) {nSubsidy =      10.00 * COIN;}
    else if (nHeight >=  338501 && nHeight <=  404200) {nSubsidy =       9.50 * COIN;}
    else if (nHeight >=  404201 && nHeight <=  469900) {nSubsidy =       9.00 * COIN;}
    else if (nHeight >=  469901 && nHeight <=  535600) {nSubsidy =       8.50 * COIN;}
    else if (nHeight >=  535601 && nHeight <=  601300) {nSubsidy =       8.00 * COIN;}
    else if (nHeight >=  601301 && nHeight <=  732700) {nSubsidy =       7.75 * COIN;}
    else if (nHeight >=  732701 && nHeight <=  864100) {nSubsidy =       7.50 * COIN;}
    else if (nHeight >=  864101 && nHeight <=  995500) {nSubsidy =       7.25 * COIN;}
    else if (nHeight >=  995501 && nHeight <= 1126900) {nSubsidy =       7.00 * COIN;}
    else if (nHeight >= 1126901 && nHeight <= 1258300) {nSubsidy =       6.75 * COIN;}
    else if (nHeight >= 1258301 && nHeight <= 1389700) {nSubsidy =       6.50 * COIN;}
    else if (nHeight >= 1389701 && nHeight <= 1521100) {nSubsidy =       6.25 * COIN;}
    else if (nHeight >= 1521101 && nHeight <= 1652500) {nSubsidy =       6.00 * COIN;}
    else if (nHeight >= 1652501 && nHeight <= 1783900) {nSubsidy =       5.75 * COIN;}
    else if (nHeight >= 1783901 && nHeight <= 1915300) {nSubsidy =       5.50 * COIN;}
    else if (nHeight >= 1915301 && nHeight <= 2046700) {nSubsidy =       5.25 * COIN;}
    else if (nHeight >= 2046701 && nHeight <= 2178100) {nSubsidy =       5.00 * COIN;}
    else if (nHeight >= 2178101 && nHeight <= 2309500) {nSubsidy =       4.75 * COIN;}
    else if (nHeight >= 2309501 && nHeight <= 2440900) {nSubsidy =       4.50 * COIN;}
    else if (nHeight >= 2440901 && nHeight <= 2572300) {nSubsidy =       4.25 * COIN;}
    else if (nHeight >= 2572301 )                      {nSubsidy =       4.00 * COIN;}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        ...
        return nSubsidy;
         ...
         if (nHeight >=       1 && nHeight <=    150)  {nSubsidy = 0;}
    else if (nHeight >=     151 )                       {nSubsidy = blockValue * 0.70;}
...
{
    RenameThread("cbslcoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // CBSLCOIN: We use certain sporks during IBD, so check to see if they are
        ...
        vector<CInv> vInvWait;
        {
            ...
            BOOST_FOREACH (const CInv& inv, pto->vInventoryToSend) {
                ...
                if (inv.type == MSG_TX && !fSendTrickle) {
                    // 1/4 of tx invs cbsl to all immediately
                    static uint256 hashSalt;
                    if (hashSalt == 0)
                        hashSalt = GetRandHash();
