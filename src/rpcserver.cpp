...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cbslcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cbslcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cbslcoin features */
        {"cbslcoin", "masternode", &masternode, true, true, false},
        {"cbslcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cbslcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cbslcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cbslcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cbslcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cbslcoin", "startmasternode", &startmasternode, true, true, false},
        {"cbslcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cbslcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cbslcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cbslcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cbslcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cbslcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cbslcoin", "mnbudget", &mnbudget, true, true, false},
        {"cbslcoin", "preparebudget", &preparebudget, true, true, false},
        {"cbslcoin", "submitbudget", &submitbudget, true, true, false},
        {"cbslcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cbslcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cbslcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cbslcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cbslcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cbslcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cbslcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cbslcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cbslcoin", "mnsync", &mnsync, true, true, false},
        {"cbslcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> cbslcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28868/\n";
}
