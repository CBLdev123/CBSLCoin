Contributing to Cbslcoin Core
==================================

The Cbslcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cbslcoin Core project, and is not to be
confused with overall Cbslcoin Network Protocol consensus changes.

Whether a pull request is merged into Cbslcoin Core rests with the project merge
...
Patches that change Cbslcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cbslcoin consensus, it must have been
...
The project leader is the release manager for each Cbslcoin Core release.
