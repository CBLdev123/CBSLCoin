...
RESOURCES += src/qt/cbslcoin.qrc src/qt/cbslcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cbslcoin_bg.ts \
                src/qt/locale/cbslcoin_de.ts \
                src/qt/locale/cbslcoin_en.ts \
                src/qt/locale/cbslcoin_es.ts \
                src/qt/locale/cbslcoin_fi.ts \
                src/qt/locale/cbslcoin_fr.ts \
                src/qt/locale/cbslcoin_it.ts \
                src/qt/locale/cbslcoin_ja.ts \
                src/qt/locale/cbslcoin_pl.ts \
                src/qt/locale/cbslcoin_pt.ts \
                src/qt/locale/cbslcoin_ru.ts \
                src/qt/locale/cbslcoin_sk.ts \
                src/qt/locale/cbslcoin_sv.ts \
                src/qt/locale/cbslcoin_vi.ts \
                src/qt/locale/cbslcoin_zh_CN.ts \
                src/qt/locale/cbslcoin_zh_TW.ts
