...
Intro
-----
Cbslcoin (CBSL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Cbslcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cbslcoin-qt.exe.

Cbslcoin Core is the original Cbslcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Cbslcoin transactions;
