...
In order to support loading of multiple wallets in cbslcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cbslcoin.cpp.
...
Changes to cbslcoin.cpp
----------------------
cbslcoin.cpp is the entry point into cbslcoin-qt, and as such, will require some minor modifications to provide hooks for
