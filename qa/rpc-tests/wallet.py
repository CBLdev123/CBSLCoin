...
#   c) node1 mines 32 blocks, so now node 0 has 500000CBSL, node 1 has 4250CBSL, node2 has none.
#   d) node0 sends 601 CBSL to node2, in two transactions (301 CBSL, then 300 CBSL).
